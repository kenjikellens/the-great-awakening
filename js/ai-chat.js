    ...
    constructor() {
        ...
        this.thematicMatrix = [
            ...
            },
            {
                ...
                keywords: ['social credit', 'sesame', 'digital id', 'eidas', 'biometrics', 'biometric', 'id2020', 'neuralink', 'bci', 'musk', 'brain chip', 'surveillance state', 'digital wallet', 'identity framework', 'universal id', 'ai act', 'artificial intelligence', 'fisa', 'section 702', 'warrantless', 'worldcoin', 'world id', 'orb', 'iris scan', 'sam altman', 'proof of personhood', 'executive order 14110', 'ai safety', 'watermarking', 'content provenance', 'c2pa', 'palantir', 'gotham', 'predictive policing', 'thiel', 'karp', 'flock', 'flock safety', 'alpr', 'anpr', 'license plate', 'cameras', 'ring', 'doorbell', 'amazon', 'warrantless sharing', 'police access', 'familiar faces']
            }
        ];
